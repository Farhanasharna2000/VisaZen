...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className={`shadow-md fixed w-full z-10 py-2 ${theme === "light" ? "bg-[#ff0000e1]" : "bg-gray-800"}`}>
        <div className="navbar container mx-auto">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content bg-[#ff0000e1] rounded-box z-[1] mt-3 w-52 p-2 shadow"
              >
                {links}
              </ul>
            </div>
          ...
          <button
            onClick={toggleTheme}
            className="btn btn-ghost rounded-full py-2  "
          >
            {theme === 'light' ? (
